...
class PipelineGui:
    ...
    def __init__(self):
        ...
        self.submit_button = tk.Button(self.parent, text="Submit", command=self.OnClick, width=20).grid(row=7, column=2)
        self.asd = "sadsadsa"
